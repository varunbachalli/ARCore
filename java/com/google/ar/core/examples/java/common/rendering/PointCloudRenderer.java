...
//    publishPc.start();
  ...
  public void update(PointCloud cloud) {
    ...
    FloatBuffer pointCloudData = cloud.getPoints();
    IntBuffer pointCloudIds = cloud.getIds();
    ...
    GLES20.glBufferSubData(
        GLES20.GL_ARRAY_BUFFER, 0, numPoints * BYTES_PER_POINT, pointCloudData);
    GLES20.glBindBuffer(GLES20.GL_ARRAY_BUFFER, 0);
...
//      public void run() {
//        // lastTimestamp
//        float[] pointCloudArray;
//        int[] pointCloudIdsArray;
//        pointCloudIdsArray = new int[pointCloudIds.limit()];
//        pointCloudIds.get(pointCloudIdsArray);
//        pointCloudArray = new float[pointCloudData.limit()];
//        pointCloudData.get(pointCloudArray); // gets id's and points
//
//        String text = "";
//        if (pointCloudIdsArray.length > 0) {
//          for (int i = 0; i < pointCloudIdsArray.length; i++) {
//
//            text+=  Long.toString(lastTimestamp) + ";" +
...
//        }
//
//        File path = HelloArActivity.getContext().getFilesDir();
//        File file = new File(path, "pointClouds.txt");
//        try {
//          FileOutputStream stream = new FileOutputStream(file,true);
//          stream.write(text.getBytes());
//          stream.close();
//          Toast.makeText(HelloArActivity.getContext(),"file has been written in" + path.toString() + file.toString(), Toast.LENGTH_SHORT).show();

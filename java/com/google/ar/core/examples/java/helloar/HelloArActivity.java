...
import com.google.ar.core.examples.java.common.rendering.ColorExtraction;
import com.google.ar.core.examples.java.common.rendering.DataExtraction;
...
public class HelloArActivity extends AppCompatActivity implements GLSurfaceView.Renderer {
    ...
    private static final String FILE_NAME = "PointClouds.txt";
    ...
    private final ColorExtraction colorExtraction = new ColorExtraction();
    private ArrayList<Anchor> Anchors_List = new ArrayList<>();
    ...
    boolean saveColorImage = false;

    public void setColorBool(View v) {
        saveColorImage = true;
    }
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        ...
        try {
            ...
            // New stuff here
            dataExtraction.onCreate();
            colorExtraction.onCreate();
        } catch (IOException e) {
    ...
    public void onDrawFrame(GL10 gl) {
        ...
        try {
            ...
            for (ColoredAnchor coloredAnchor : anchors) {
                ...
                Anchors_List.add(coloredAnchor.anchor);
            }
            float[] Cam_pose = new float[7];
            camera.getPose().getRotationQuaternion(Cam_pose, 0);
            camera.getPose().getTranslation(Cam_pose, 4);
            float[] focalLength = new float[2];
            camera.getImageIntrinsics().getFocalLength(focalLength, 0);
            if (saveData_now) {
                saveData_now = false;
                dataExtraction.saveData(frame, Anchors_List, projmtx, viewmtx, Cam_pose, focalLength);
            }

            if (saveColorImage) {
                saveColorImage = false;
                colorExtraction.saveWallColor(frame);
            }
        } catch (Throwable t) {
    ...
    boolean saveData_now = false;

    public void setDataBool(View v) {
        saveData_now = true;
    }
